...
// import { LucideCalendar, ClipboardPenLine, Tag, UserRound, TriangleAlert, ChartLine, CalendarDays } from "lucide-react";
...
// // export function DataTable({ employeeId="AAS-IA-08-25" }) {
...
//   const { teamsByEmployee } = useSelector((state) => state.team);
...
//       </p>
//       <p className="text-sm text-muted-foreground flex items-center gap-2">
//         <CalendarDays /> Deadline: {new Date(item.deadline).toLocaleDateString()}
//       </p>
//     </div>
//   );
...
//         {isLoading ? (
//           <div className="text-center text-sm py-6">Loading tasks...</div>
//         ) : error ? (
//           <div className="text-center text-sm text-red-600 py-6">{error}</div>
//         ) : employeeTasks?.length > 0 ? (
//           <>
//             {paginate(employeeTasks, page).map((task) => (
//               <Dialog
//                 key={task._id}
...
//               </Dialog>
//             ))}
//             {renderPagination(employeeTasks.length)}
//           </>
//         ) : (
//           <div className="text-center text-sm text-muted-foreground py-6">No tasks found for this employee.</div>
//         )}
//       </div>
//     </div>
//   );
...
//   const renderTasks = () => {
//     if (isLoading) return <div className="text-center text-sm py-6">Loading tasks...</div>;
//     if (error) return <div className="text-center text-sm text-red-600 py-6">{error}</div>;
//     if (!employeeTasks?.length) return <div className="text-center text-sm text-muted-foreground py-6">No tasks found.</div>;
...
//                   </div>
//                 </div>
//                 <Badge className={task.status === "Completed" ? "bg-green-600 text-white" : "bg-muted text-muted-foreground"}>
//                   {task.status}
//                 </Badge>
//               </div>
//             </DialogTrigger>
...
//       return <div className="text-center text-sm text-muted-foreground py-6">No projects found.</div>;

//     return (
//       <>
//         {paginate(employeeProjects, page).map((project) => (
//           <div key={project._id} className="p-4 mb-3 border border-border rounded-lg">
//             <h3 className="text-sm font-semibold text-foreground flex items-center gap-2">
//               <Briefcase className="h-4 w-4 text-muted-foreground" /> {project.projectName}
//             </h3>
//             <p className="text-xs text-muted-foreground">ID: {project.projectId}</p>
//             <p className="text-xs text-muted-foreground">Team Lead: {project.teamLeadName}</p>
//           </div>
//         ))}
//         {renderPagination(employeeProjects.length)}
//       </>
//     );
//   };

//   const renderTeams = () => {
//     if (!teamsByEmployee?.length)
//       return <div className="text-center text-sm text-muted-foreground py-6">No teams found.</div>;

//     return (
//       <>
//         {paginate(teamsByEmployee, page).map((team) => (
//           <Dialog
//             key={team._id}
...
//           >
//             <DialogTrigger asChild>
//               <div className="p-4 mb-3 border border-border rounded-lg cursor-pointer hover:bg-muted/40 transition">
//                 <h3 className="text-sm font-semibold text-foreground flex items-center gap-2">
//                   <Users className="h-4 w-4 text-muted-foreground" /> Team ID: {team.teamId}
//                 </h3>
//                 <p className="text-xs text-muted-foreground">Project: {team.projectName}</p>
//                 <p className="text-xs text-muted-foreground">Team Lead: {team.teamLeadName}</p>
//               </div>
//             </DialogTrigger>
//             <DialogContent className="bg-background border-border rounded-lg max-w-lg">
//               <DialogHeader>
...
//                   <div key={member._id} className="border p-2 rounded-md">
...
//           </Dialog>
//         ))}
//         {renderPagination(teamsByEmployee.length)}
//       </>
//     );
//   };
