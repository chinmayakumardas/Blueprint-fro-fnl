...
//                     (sortDirection === 'asc' ? <FiArrowUp className="inline ml-1" /> : <FiArrowDown className="inline ml-1" />)}
//                 </TableHead>
//                 <TableHead className="text-green-800">DeadLine</TableHead>
//                 <TableHead
//                   className="text-green-800 cursor-pointer"
...
//                 <Label className="text-right text-green-700">Task ID</Label>
...
//                 <span className="col-span-3 text-green-900">{viewTask.reviewStatus}</span>
//               </div>
//               <div className="grid grid-cols-4 items-center gap-4">
...
const AllTasksList = () => {
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      // Include delayReason in payload if deadline has passed
        ...
        <Dialog open={!!viewTask} onOpenChange={() => setViewTask(null)}>
          <DialogContent className="sm:max-w-[425px] bg-white border-green-200">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label className="text-rightturn text-green-700">Description</Label>
                <span className="col-span-3 text-green-900">{viewTask.description}</span>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label className="text-right text-green-700">Project</Label>
              ...
              {isDeadlinePassed(viewTask) && viewTask.delayReason && (
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right text-green-700">Delay Reason</Label>
                  <span className="col-span-3 text-green-900">{viewTask.delayReason}</span>
                </div>
              )}
            </div>
          </DialogContent>
